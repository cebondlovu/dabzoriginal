...
public class RxFirebaseAuth {
     ...
     * by {@link FirebaseAuth#sendPasswordResetEmail(String)} or {@link FirebaseUser#sendEmailVerification()} valid for a single use.
     *
     * @param firebaseAuth firebaseAuth instance.
     ...
     * Password changes for signed-in users should be made using {@link FirebaseUser#updatePassword(String)}.
     *
     * @param firebaseAuth firebaseAuth instance.
     * @param code         generated code by firebase.
